...
do
  ...
  function class.get(self, k) return private[self][k] end
  function class.set(self, k, v) private[self][k] = v end
  class.__index = class
...
bench(string.format("access using variables, %d times: ", N), 
